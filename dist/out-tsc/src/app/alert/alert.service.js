...
var AlertService = /** @class */ (function () {
    function AlertService(alertContoller) {
        this.alertContoller = alertContoller;
    }
    /**
     *
     ...
     */
    AlertService.prototype.presentAlert = function (header, subHeader, message, buttons) {
        if (header === void 0) { header = 'hey'; }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertContoller.create({
                            header: header,
                            subHeader: subHeader,
                            message: message,
                            buttons: buttons
